...
Run the test suite and confirm it is green BEFORE touching anything:
  ...
  Expected: 96/96 passing across 13 groups.
...
AFTER ANY VISUAL WORK: re-run tests/backend.html. It must still be 96/96.
...
=====================================================================
  ...
  - Report honestly: distinguish what is VERIFIED from what is ASSUMED.
    The previous session drew this line carefully — 96 checks prove our code
...
| **Whether it still works** | `tests/backend.html` — 96 checks |
