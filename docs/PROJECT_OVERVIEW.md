...
| No auth, no tests, dashboards capped at 30 members | Sessions, capabilities, 97 automated checks, no cap |
...
| N7 | Server-side authorisation on every action | ✅ 97 checks |
...
deployment tooling, and the approved visual design. 97 automated checks
passing.
...
| Automated verification | ✅ 97/97 passing |
